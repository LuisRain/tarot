...
public class Uploader
{
  ...
  private java.util.HashMap<String, String> errorInfo = new java.util.HashMap();
  ...
  {
    boolean isMultipart = 
      org.apache.commons.fileupload.servlet.ServletFileUpload.isMultipartContent(this.request);
    if (!isMultipart) {
  ...
  private void parseParams()
  {
    ...
    try {
      org.apache.commons.fileupload.servlet.ServletFileUpload sfu = new org.apache.commons.fileupload.servlet.ServletFileUpload(dff);
      ...
      while (fii.hasNext()) {
        org.apache.commons.fileupload.FileItemStream item = fii.next();
