  ...
  implements Serializable
{
  ...
  public void setQX_ID(String qX_ID) { this.QX_ID = qX_ID; }
  ...
  public void setADD_QX(String aDD_QX) { this.ADD_QX = aDD_QX; }
  
  public String getDEL_QX() {
    return this.DEL_QX;
  }
  
  public void setDEL_QX(String dEL_QX) { this.DEL_QX = dEL_QX; }
  
  public String getEDIT_QX() {
    return this.EDIT_QX;
  }
  
  public void setEDIT_QX(String eDIT_QX) { this.EDIT_QX = eDIT_QX; }
  
  public String getCHA_QX() {
    return this.CHA_QX;
  }
  
  public void setCHA_QX(String cHA_QX) { this.CHA_QX = cHA_QX; }
}
