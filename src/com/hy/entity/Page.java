...
public class Page
{
  ...
  public Page() {
    try { this.showCount = Integer.parseInt(Tools.readTxtFile("admin/config/PAGE.txt"));
    } catch (Exception e) {
      this.showCount = 15;
    }
  }
  ...
  public String getPageStr() {
    ...
    if (this.totalResult > 0) {
      ...
      sb.append("\t<li><select title='显示条数' style=\"width:60px;float:left;\" onchange=\"changeCount(this.value)\">\n");
