...
<div id="page-content" class="clearfix">
  <div class="row-fluid">
	<div class="row-fluid">
			<!-- 检索  -->
			<form action="product/listProduct.do" method="post" id="ProductForm">
			<c:if test="${QX.cha == 1 }">
			<table>
				<tr><td>
					...
					<c:when test="${not empty productList}">
						...
						<c:forEach items="${productList}" var="product" varStatus="vs">
							...
							<tr>
								...
								<td>
								<c:if test="${QX.edit == 1 }">
								<a class='btn btn-mini btn-info' title="编辑" onclick="edit('${product.id}','${product.ROLE_ID}');"><i class='icon-edit'></i></a></c:if>
...
//删除
		...
		function edit(Id,ROLE_ID){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>product/goEditP.do?productId='+Id+'&ROLE_ID='+ROLE_ID;
			 diag.Width = 800;
			 diag.Height = 800;
