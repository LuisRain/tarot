...
<body>
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<div class="row-fluid">
					<form action="exwarehouseorder/cplist.do" method="post" name="Form"
						id="Form">
							...
							<input class="span10 date-picker" id="orderdate" name="order_date" value="${pd.order_date}"
							 ...
							 <input autocomplete="off" 	id="nav-search-input" type="text" name="keyword" 	value="${pd.keyword}" placeholder="这里输入关键词" />
											<select name="ivt_state" id="ivt_state">
												...
												<option value="3">3-标签系统正在分拣</option>
	...
	<script type="text/javascript">
		...
		function SelectNo() {
		  ...
		  function editProductNumber(id1,type){
			var url='<%=basePath%>exwarehouseorder/cpgoExwareorderProductEdit.do?orderId='+id1+'&type=1';
				top.mainFrame.tabAddHandler("392060853225","查看出库单信息",url);
			 
		 } 
			 //查看出库单标签系统分类详情-分量详情
		  function editProductNumberPQ(id1,type){
			var url='<%=basePath%>exwarehouseorder/cpgoExwareorderProductEditPQ.do?orderId='+id1+'&type='+type;
