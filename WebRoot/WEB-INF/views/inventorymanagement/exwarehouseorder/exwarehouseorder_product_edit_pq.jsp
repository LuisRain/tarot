  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
		...
		打印
			...
			<form action="exwarehouseorder/goExwareorderProductEditPQ.do?orderId=${enwarhouse.order_num}	" method="post" name="Form" id="Form">
							...
							type="number" value="${o.sale_price}" minFractionDigits="2" maxFractionDigits="4" /></td>
								...
								<td class="center">
									...
									<input style="display: none" type="text" name="orderItemId" VALUE="${o.id}">
												...
												<td>${o.gift_quantity }(${o.unit_name})</td>
