...
<script type="text/javascript" src="static/js/twomsswms_print.js"></script>
 <style type="text/css">
		.clear{clear: both;}
		body,td,th{font: 13px/1.5 "Microsoft yahei",SimHei normal;font-family: "宋体";font-weight:bold;}
 ...
 <body>
	...
	<div class="print-title" id="headerInfo">
		<h4>中石油山西${va.merchant_num}${va.area_name}昆仑好客便利店</h4>
		<h2>中央仓配送商品验收单</h2>
	...
	<thead>
		...
		<c:choose>
				...
				<td colspan="3"style="text-align: left;">运输： </td>
