...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			//保存
			function save(){
				if($("#excel").val()=="" || document.getElementById("excel").files[0] =='请选择ssxlsx格式的文件'){
					$("#excel").tips({
						side:3,
			            msg:'请选择文件',
			            bg:'#AE81FF',
			...
			function fileType(obj){
			    ...
			    if(fileType != '.xlsx'){
			    	...
			    	$("#excel").val('');
			    	document.getElementById("excel").files[0] = '请选择sxlsx格式的文件';
			    }
			}
		</script>
	</head>
<body>
	<form action="exwarehouseorder/readExOrderExcel.do" name="sellingOrderForm" id="sellingOrderForm" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>exwarehouseorder/downExOrderExcel.do'">下载出库单模版</a>
				</td>
			</tr>
		</table>
		</div>
		
		<!-- <div id="zhongxin2" class="center" >标红为必填字段<br/><img src="static/images/exOrder.png" /><br/><h4 class="lighter block green"></h4></div> -->
