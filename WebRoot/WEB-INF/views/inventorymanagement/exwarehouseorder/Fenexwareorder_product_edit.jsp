...
<link href="<%=basePath%>static/css/bootstrap.min.css" rel="stylesheet" />
	...
	<script type="text/javascript" src="<%=basePath%>static/js/jQuery.print.js"></script>
		...
		function print(){
			window.open("<%=basePath%>exwarehouseorder/FenCangprint.do?orderId=${enwarhouse.order_num}&type=1", "", 'left=250,top=150,width=1400,height=500,toolbar=no,menubar=no,status=no,scrollbars=yes,resizable=yes');	
		}
		</script>
<body>
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
		...
		打印
			...
			<form action="exwarehouseorder/FengoExwareorderProductEdit.do?orderId=${enwarhouse.order_num}	" method="post" name="Form" id="Form">
				...
				<c:choose>
				 ...
				 <c:if test="${enwarhouse.ivt_state eq 1}">
								<tr id="noprint">
									...
									<td colspan="6" class="center"  ><a style="text-align: center;"
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function search(){
		  ...
		  function editProductNumber(id1){
			var url='<%=basePath%>exwarehouseorder/FengoExwareorderProductEdit.do?type=1&orderId='+id1;
