								...
								<td><span class="input-icon"> <input
									...
									<i id="nav-search-icon" class="icon-download-alt"></i>
										...
										<c:if test="${pd.ivt_state eq 3}">
											<!-- <a class="btn btn-mini btn-light"
												onclick="toCombineEXTotoExcel('确定要波次操作您所选的出库单吗?');"
												title="合并出库单"> <i id="nav-search-icon"
												class="icon-exchange"></i>
											</a> -->
											<a class="btn btn-mini btn-light" onclick="tomergeEx('确定要合并订单吗?');" title="合并出库单"> 
