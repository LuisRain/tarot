...
<div id="page-content" class="clearfix">
  <div class="row-fluid">
	<div class="row-fluid">
			<!-- 检索  -->
			<form action="enwarehouseorder/listOfGift.do" method="post" name="Form" id="Form">
			<table>
				<tr><td>
							...
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										...
										<td><a onclick="editProductNumber('${var.order_num}',1)">${var.order_num}</a></td>
										 <c:if test="${var.ivt_state eq  1 and var.order_type eq  3}">
										<td>
										 待入库
										</td>
										</c:if>
										 <c:if test="${var.ivt_state eq  2 and var.order_type eq  3}">
										<td>
										  已入库
										</td>
										</c:if>
