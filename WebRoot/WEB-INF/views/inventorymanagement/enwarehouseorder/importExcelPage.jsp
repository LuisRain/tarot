...
<body>
	<form action="enwarehouseorder/readENOrderExcel.do" name="sellingOrderForm" id="sellingOrderForm" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>enwarehouseorder/downEnOrderExcel.do'">下载入库订单模版</a>
				</td>
			</tr>
		</table>
		</div>
		
		<div id="zhongxin2" class="center" >标红为必填字段<br/><img src="static/images/drrk.png" /><br/><h4 class="lighter block green"></h4></div>
