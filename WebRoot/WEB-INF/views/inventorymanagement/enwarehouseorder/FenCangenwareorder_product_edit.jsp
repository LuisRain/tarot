		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<form
						action="enwarehouseorder/FengoEnwareorderProductEdit.do?orderId=${enwarhouse.order_num}	"
       ...
       <th 	class='center'  >序号</th>
                     ...
                     <c:if test="${enwarhouse.ivt_state eq 1}">
								<tr id="noprint">
									...
									<td colspan="6" class='center'  ><a class="btn btn-mini btn-primary"  style="text-align: center;"
		...
		function editProductNum(id){
		 ...
		 //修改商品数量
		  ...
		  function editProductNumber(id1){
			var url='<%=basePath%>enwarehouseorder/FengoEnwareorderProductEdit.do?type=1&orderId='+id1;
