...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="enwarehouseorder/enTemplistPage.do?type=2" method="post" name="Form" id="Form">
			<c:if test="${QX.cha == 1 }">
			<table>
				<tr>
						<td>
		...
		<!-- 	 <a class="btn btn-mini btn-light" onclick="fromExcel();" title="导入EXCEL"><i id="nav-search-icon" class="icon-cloud-upload"></i></a> -->
					...
					<%--   <a href="<%=basePath%>enwarehouseorder/goImportTempExcel">导入excel</a> --%>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function add(){
			...
			location.href="<%=basePath%>enwarehouseorder/goSaveTemp.do?type=2";
