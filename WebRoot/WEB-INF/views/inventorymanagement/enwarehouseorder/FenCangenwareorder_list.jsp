	...
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<div class="row-fluid">
					<!-- 检索  -->
					<form action="enwarehouseorder/fencanglist.do" method="post" name="Form"
						id="Form">
						<c:if test="${QX.cha == 1 }">
						<table>
							<tr>
								...
								<td><select name="ivt_state" id="ivt_state">
								...
								<td style="vertical-align:top;">
									...
									</button> <c:if test="${pd.ivt_state eq  1}">
										...
										<c:forEach items="${varList}" var="var" varStatus="vs">
											<tr>
												...
												<td class='center'><c:if
														test="${var.ivt_state eq  1 and var.order_type eq  1}">
										 待入库
										</c:if> <c:if test="${var.ivt_state eq  2 and var.order_type eq  1}">
										  已入库
										</c:if></td>
		...
		function del(Id){
		 ...
		 //修改商品数量
		  function editProductNumber(id1,type){
			var url='<%=basePath%>enwarehouseorder/FengoEnwareorderProductEdit.do?orderId='+id1+'&type='+type;
