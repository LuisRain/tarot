...
//搜索商品
	 ...
	 diag.OKEvent = function(){
		 ...
		 $("#exProductId").val(pid);
		    $.post("<%=basePath%>/product/findProductById?productId="+pid,function(data){
		    	        ...
		    	        $("#inventory3").val(data.product.inventory3);
 ...
 function save(){
		var numberTest=/^[0-9]*$/;
	     ...
	     if($("#warhouseId").val()==1){
	    	 if(parseInt($("#newQuantity").val())>parseInt($("#inventory").val())){
	     ...
	     }else if($("#warhouseId").val()==2){
	    	 
	    	 if(parseInt($("#newQuantity").val())>parseInt($("#inventory2").val())){
	    	 ...
	    	 if(parseInt($("#newQuantity").val())>parseInt($("#inventory3").val())){
...
<body>
	<form action="<%=basePath%>exwarehouseorder/addTempOrder.do?type=1" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<td>选择商品:</td>
				<td>
				  <input type="text" name="productId"  id="exProductId" style="display: none">
				<input  
	 	...
	 	<tr>
			...
			<tr>
			 <Td>储存库:</Td>
			 <Td><input type="text" readonly="readonly"  id="inventory3"    ></Td> 
			 <td>生产日期:</td>
			 ...
			 <td>入库原因:</td>
			  ...
			  <select name="reason" id="reason">
			    <option  value="-1">请选择</option>
			       <option value="01-客户临时购货">01-客户临时购货</option>
			          <option value="02-给客户的临时赠品">02-给客户的临时赠品</option>
			             <option value="03-仓库盘点受损">03-仓库盘点受损</option>
			                <option value="04-客户关系送礼">04-客户关系送礼</option>
			                   <option value="05-向供应商临时退货">05-向供应商临时退货</option>
			                    <option value="06-过期破损">06-过期破损</option>
			                    <option value="99-其它">99-其它</option>
