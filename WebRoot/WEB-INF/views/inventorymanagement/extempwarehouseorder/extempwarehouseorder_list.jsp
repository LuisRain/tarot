  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<select id="searchcriteria" name="searchcriteria" onchange="loaddate()">  
              ...
              <option value ="2">2-按出库日期</option>  
					...
					<Td> 
					<!--  <a class="btn btn-mini btn-light" onclick="fromExcel();" title="导入EXCEL"><i id="nav-search-icon" class="icon-cloud-upload"></i></a> -->
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function add(){
			...
			location.href="<%=basePath%>exwarehouseorder/goSaveTemp.do?type=1";
		...
		$(function() {
			...
			function fromExcel(){
				 ...
				 diag.URL = '<%=basePath%>importentempwarehouseorder/goImportTempExcel.do?type=1';
				 diag.Width = 500;
				 diag.Height = 300;
