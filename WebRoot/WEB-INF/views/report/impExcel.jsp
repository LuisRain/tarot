...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			//保存
			function save(){
				if($("#excel").val()=="" || document.getElementById("excel").files[0] =='请选择xlsx格式的文件'){
					$("#excel").tips({
						side:3,
			            msg:'请选择文件',
			            bg:'#AE81FF',
			...
			function fileType(obj){
			    ...
			    if(fileType != '.xlsx'){
			    	...
			    	$("#excel").val('');
			    	document.getElementById("excel").files[0] = '请选择xlsx格式的文件';
			    }
			}
		</script>
	</head>
<body>
	<form action="reportController/readExcel.do" name="productInfoForm" id="productInfoForm" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>product/downExcel.do'">下载批量导入商品信息模版</a>
				</td>
			</tr>
		</table>
		</div>
	...
	<div class="step-content row-fluid position-relative">
		...
		<ul class="unstyled spaced2"> <li class="text-warning red"><i class="icon-warning-sign"></i>${Msg }</li> 
		<c:choose>
