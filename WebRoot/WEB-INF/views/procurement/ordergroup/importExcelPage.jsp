...
<body>
	<form action="sellingorder/readExcel2.do" name="sellingOrderForm" id="sellingOrderForm" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>sellingorder/downXlsxExcel.do'">下载销售订单模版</a>
				</td>
			</tr>
		</table>
		</div>
