					...
					<c:when test="${not empty productList}">
						<c:forEach items="${productList}" var="product" varStatus="vs">
							<tr>
								...
								<td><a href="javascript:checkTypeInventory('${product.product_num}')">${product.product_name}</a></td>
...
//删除
		...
		function makeAll(msg){
			...
			* 查看详情
			*/
		function checkTypeInventory(productNum){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL  = '<%=basePath%>product/fundGroupProduct.do?productNum='+productNum;
			 diag.Width = 1000;
			 diag.Height = 700;
