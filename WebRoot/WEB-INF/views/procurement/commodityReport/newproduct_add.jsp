	   ...
	   <input type="hidden" name="CARGO_SPACE_ID"  value="${product.tcsid}"/>
		...
		<tr>
			...
			<%-- <tr>
				...
				<c:otherwise>
				<td  colspan="2"><input type="text" disabled="disabled" name="product_num" id="product_num" value="${product.product_num}" maxlength="32" placeholder="这里输入商品编码" title="商品编码"/></td>
				</c:otherwise>
				</c:choose>
			</tr> --%>
