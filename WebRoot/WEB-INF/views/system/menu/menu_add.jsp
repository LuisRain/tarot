...
<script type="text/javascript">
	...
	function save() {
		...
		$("#PARENT_ID1").val($("#parentId option:selected").val());
		$("#menuForm").submit();
		$("#zhongxin").hide();
		$("#zhongxin2").show();
	}
...
<body>
	<form action="menu/add.do" name="menuForm" id="menuForm" method="post">
		...
		<input type="hidden" name="PARENT_ID1" id="PARENT_ID1" value="" />
		<div id="zhongxin">
			<table>
				<tr>
					<td><select name="PARENT_ID" id="parentId" class="input_txt"
						onchange="setMUR()" title="菜单">
				...
				<tr>
					<td><input type="text" name="MENU_URL" id="menuUrl"
						placeholder="这里输入链接地址" value="" title="地址" /></td>
				</tr>
				<tr>
					<td><input type="number" name="MENU_ORDER" id="menuOrder"
						placeholder="这里输入序号" value="" title="序号" /></td>
				</tr>
				<tr>
					<td style="text-align: center;"><label
						style="float:left;padding-left: 32px;"><input
							name="form-field-radio" id="form-field-radio1"
							onclick="setType('1');" type="radio" value="icon-edit"><span
							class="lbl">系统菜单</span></label> <label
