...
<link href="<%=basePath%>static/css/bootstrap.min.css" rel="stylesheet" />
	...
	<script type="text/javascript" src="<%=basePath%>static/js/jQuery.print.js"></script>
		...
		function print(){
			window.open("<%=basePath%>thproduct/cgprint.do?order_num=${enwarhouse.order_num}&type=1", "", 'left=250,top=150,width=1400,height=500,toolbar=no,menubar=no,status=no,scrollbars=yes,resizable=yes');	
		}
		</script>
<body>
		...
		<tr>
			 <td style="width:70px;text-align: right;padding-top: 13px;">订单编号:</td>
				<td>
				 ...
				 <td style="width:70px;text-align: right;padding-top: 13px;">供应商名称:</td>
				<td>
			          ${enwarhouse.supplier_name}
				</td>
			...
			<tr>
			 <td style="width:70px;text-align: right;padding-top: 13px;">订购日期:</td>
				<td>
				${fn:substring(enwarhouse.create_time,0,16)}
				</td>
			...
			<tr>
				 ...
				 <td style="width:90px;text-align: right;padding-top: 13px;">取货地址:</td>
				<td>
			          ${enwarhouse.deliver_address}
				</td>
