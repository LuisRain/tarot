...
<link href="<%=basePath%>static/css/bootstrap.min.css" rel="stylesheet" />
	...
	<script type="text/javascript" src="<%=basePath%>static/js/jQuery.print.js"></script>
		...
		function print(){
			window.open("<%=basePath%>thproduct/thprint.do?order_num=${sell.order_num}&type=1", "", 'left=250,top=150,width=1400,height=500,toolbar=no,menubar=no,status=no,scrollbars=yes,resizable=yes');	
		}
		</script>
<body>
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
		...
		打印
			...
			<form action="exwarehouseorder/goExwareorderProductEdit.do?orderId=${sell.order_num}	" method="post" name="Form" id="Form">
		<table id="table_report" class="table table-striped table-bordered table-hover">
		  <tr><td style="width:100px;text-align: right" >基本信息:</td>
		  <td  colspan="5"  style="width:100px;text-align: left" >${sell.merchant_id}</td>
		  </tr>
		
		<tr>
			 <td style="width:70px;text-align: right;padding-top: 13px;">退货单编号:</td>
				<td>
			         ${sell.order_num}
				</td>
				 <td style="width:70px;text-align: right;padding-top: 13px;">门店名称:</td>
				<td>
			          ${sell.merchant_name}
				</td>
			...
			<tr>
			 <td style="width:70px;text-align: right;padding-top: 13px;">退货日期:</td>
				<td>
				${fn:substring(sell.create_time,0,16)}
				</td>
			 
				 <td style="width:70px;text-align: right;padding-top: 13px;">出库日期:</td>
				 <Td>
				 ${fn:substring(sell.order_date,0,16)}
				 </Td>
			...
			<tr>
				...
				<td>
				  ...
				  <td style="width:120px;text-align: right;padding-top: 13px;">联系人:</td>
				<td>
			          ${sell.manager_name}
				</td>
			</tr>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							type="number" value="${o.sale_price}" minFractionDigits="2" maxFractionDigits="4" /></td>
								<td class="center"><p id="p${o.id}">
										<fmt:formatNumber type="number" value="${o.final_quantity}" maxFractionDigits="0"/> 
											 ...
											 <td class="center">
											  <fmt:formatNumber type="number" value="${o.final_quantity*o.sale_price}" minFractionDigits="2" maxFractionDigits="4" />
											 </td>
										 <td>${o.comment}</td>	
							</tr>
						</c:forEach>
				...
				<td class="center">
				<font style="color: red;font-weight:bold;"><!-- 订购总数: --> <fmt:formatNumber type="number"
							value="${sumNu.quantity}" maxFractionDigits="0" />
				</font> </td>
				<td class="center"><font style="color: red;font-weight:bold;"><!-- 出库总数:  --><fmt:formatNumber
							type="number" value="${sumNu.final_quantity}"
							maxFractionDigits="0" />
				</font> </td>
				<td class="center"><font style="color: red;font-weight:bold;"><!-- 出库单总额: -->
				<fmt:formatNumber
							type="number" value="${sumNu.final_amount}" minFractionDigits="2" maxFractionDigits="2" />
							</font></td>
